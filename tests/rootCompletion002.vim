...
edit foobar.txt
call vimtap#Is(EditSimilar#Root#CompleteAny('', '', 1), ['cpp', 'desc', 'description', 'install'], 'complete from foobar.txt')
edit fXXbaz.txt
call vimtap#Is(EditSimilar#Root#CompleteAny('', '', 1), ['cpp', 'desc', 'description', 'install'], 'complete from fXXbaz.txt')

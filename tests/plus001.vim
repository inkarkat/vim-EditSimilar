...
call vimtap#err#Errors('Substituted file does not exist (add ! to create): #008 (from #007)', '1EditPlus', 'file008.txt does not exist')
...
call vimtap#err#Errors('Substituted file does not exist (add ! to create): #019 (from #011)', '8EditPlus', 'file019.txt does not exist')
...
call vimtap#err#Errors('Substituted file does not exist (add ! to create): #039 (from #099)', 'EditMinus 60', 'file039.txt does not exist')

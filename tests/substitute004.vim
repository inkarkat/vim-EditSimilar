" Test Esubst with path separators. 
...
Esubst prod001=dev002 1/prod/=1/dev/
call vimtap#file#IsFilespec('001/dev/dev002.txt', '001/prod/prod001 -> Esubst //= -> 001/dev/dev002')
call vimtap#file#IsFile('001/prod/prod001 -> Esubst //= -> 001/dev/dev002')
...
execute 'cd' expand('<sfile>:p:h') 
edit file001.txt
Esubst file=001/prod/prod
call vimtap#file#IsFilespec('001/prod/prod001.txt', 'file001 -> Esubst =// -> 001/prod/prod001')

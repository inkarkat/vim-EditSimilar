...
"   a:hasBang	    Flag whether the built commands support a bang argument.
...
"******************************************************************************
    ...
    \   l:bangArg, a:commandPrefix, string(a:fileCommand), a:createNew, (l:omitOperationsWorkingOnlyOnExistingFiles ? '<bang>1' : 0))
